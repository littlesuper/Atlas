...
describe('feature flag helper batch 413 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    `batch413.aggregate.${index}`,
    index % 2 === 0,
  ] as const))(
    'normalizes generated batch413 AggregateError own boolean property %s',
    (name, enabled) => {
      const source = Object.assign(new AggregateError([], `batch413-${name}`), { [name]: enabled, ignored: 'true' });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch413 relay DataView own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new DataView(new Uint8Array([index]).buffer), {
        relay: enabled,
        ignored: new WeakSet(),
...
describe('feature flag helper batch 414 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    `batch414.error.${index}`,
    index % 2 === 0,
  ] as const))(
    'normalizes generated batch414 Error own boolean property %s',
    (name, enabled) => {
      const source = Object.assign(new Error(`batch414-${name}`), { [name]: enabled, ignored: 'true' });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch414 switch Float64Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 0.75]), {
        switch: enabled,
        ignored: new WeakMap(),
...
describe('feature flags batch 416 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch416 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch416 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        extra: new Set(),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 417 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch417 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch417 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 418 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch418 vector Uint32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index]), {
        vector: enabled,
        ignored: new Date(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch418 vector Uint32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 1]), {
        vector: enabled,
        extra: new Date(),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 419 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch419 lane Uint8ClampedArray own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index]), {
        lane: enabled,
        ignored: new RegExp(`batch419-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch419 lane Uint8ClampedArray alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 1]), {
        lane: enabled,
        extra: new RegExp(`alt-batch419-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 421 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch421 switch Float64Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 0.75]), {
        switch: enabled,
        ignored: new WeakMap(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch421 switch Float64Array alternate boolean property %#',
    (enabled, index) => {
...
describe('feature flags batch 422 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch422 beacon Uint8Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index]), {
        beacon: enabled,
        ignored: new Map(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch422 beacon Uint8Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 1]), {
        beacon: enabled,
        extra: new Map(),
...
describe('feature flags batch 423 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch423 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch423 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        extra: new Set(),
...
describe('feature flags batch 424 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch424 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch424 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
...
describe('feature flags batch 425 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch425 vector Uint32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index]), {
        vector: enabled,
        ignored: new Date(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch425 vector Uint32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 1]), {
        vector: enabled,
        extra: new Date(),
...
describe('feature flags batch 427 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch427 relay DataView own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new DataView(new ArrayBuffer(index + 1)), {
        relay: enabled,
        ignored: Promise.resolve(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch427 relay DataView alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new DataView(new ArrayBuffer(index + 2)), {
        relay: enabled,
        extra: Promise.resolve(),
...
describe('feature flags batch 428 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch428 switch Float64Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 0.75]), {
        switch: enabled,
        ignored: new WeakMap(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch428 switch Float64Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 1.75]), {
        switch: enabled,
        extra: new WeakMap(),
...
describe('feature flags batch 429 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch429 beacon Uint8Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index]), {
        beacon: enabled,
        ignored: new Map(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch429 beacon Uint8Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 1]), {
        beacon: enabled,
        extra: new Map(),
...
describe('feature flags batch 430 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch430 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch430 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        extra: new Set(),
...
describe('feature flags batch 431 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch431 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch431 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
...
describe('feature flags batch 432 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch432 vector Uint32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index]), {
        vector: enabled,
        ignored: new Date(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch432 vector Uint32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 1]), {
        vector: enabled,
        extra: new Date(),
...
describe('feature flags batch 433 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch433 lane Uint8ClampedArray own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index]), {
        lane: enabled,
        ignored: new RegExp(`batch433-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch433 lane Uint8ClampedArray alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 1]), {
        lane: enabled,
        extra: new RegExp(`alt-batch433-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 434 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch434 relay DataView own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new DataView(new ArrayBuffer(index + 1)), {
        relay: enabled,
        ignored: Promise.resolve(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch434 relay DataView alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new DataView(new ArrayBuffer(index + 2)), {
        relay: enabled,
        extra: Promise.resolve(),
...
describe('feature flags batch 436 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch436 beacon Uint8Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 1]), {
        beacon: enabled,
        ignored: new Map(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch436 beacon Uint8Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 2]), {
        beacon: enabled,
        extra: new Map(),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 437 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch437 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch437 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 2]), {
        signal: enabled,
        extra: new Set(),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 438 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch438 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch438 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
...
describe('feature flags batch 439 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch439 vector Uint32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 1]), {
        vector: enabled,
        ignored: new Date(Date.UTC(2026, 4, 15, index % 24, 0, 0)),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch439 vector Uint32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 2]), {
        vector: enabled,
        extra: new Date(Date.UTC(2026, 4, 15, index % 24, 0, 0)),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 440 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch440 lane Uint8ClampedArray own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 1]), {
        lane: enabled,
        ignored: new RegExp(`batch440-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch440 lane Uint8ClampedArray alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 2]), {
        lane: enabled,
        extra: new RegExp(`batch440-alt-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 442 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch442 switch Float64Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 0.75]), {
        switch: enabled,
        ignored: new WeakMap(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch442 switch Float64Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 1.75]), {
        switch: enabled,
        extra: new WeakMap(),
...
describe('feature flags batch 443 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch443 beacon Uint8Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 1]), {
        beacon: enabled,
        ignored: new Map(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch443 beacon Uint8Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 2]), {
        beacon: enabled,
        extra: new Map(),
...
describe('feature flags batch 444 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch444 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch444 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 2]), {
        signal: enabled,
        extra: new Set(),
...
describe('feature flags batch 445 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch445 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch445 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
...
describe('feature flags batch 446 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch446 vector Uint32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 1]), {
        vector: enabled,
        ignored: new Date(Date.UTC(2026, 4, 16, index % 24, 0, 0)),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch446 vector Uint32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint32Array([index + 2]), {
        vector: enabled,
        extra: new Date(Date.UTC(2026, 4, 16, index % 24, 0, 0)),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 447 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch447 lane Uint8ClampedArray own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 1]), {
        lane: enabled,
        ignored: new RegExp(`batch447-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch447 lane Uint8ClampedArray alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8ClampedArray([index + 2]), {
        lane: enabled,
        extra: new RegExp(`batch447-alt-${index}`),
      });
      const flags = normalizeFeatureFlags(source);
...
describe('feature flags batch 448 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch448 relay DataView own boolean property %#',
    (enabled, index) => {
      const buffer = new ArrayBuffer(4);
      new DataView(buffer).setUint32(0, index);
      const source = Object.assign(new DataView(buffer), {
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch448 relay DataView alternate boolean property %#',
    (enabled, index) => {
      const buffer = new ArrayBuffer(4);
      new DataView(buffer).setUint32(0, index);
      const source = Object.assign(new DataView(buffer), {
...
describe('feature flags batch 449 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch449 switch Float64Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 0.75]), {
        switch: enabled,
        ignored: new WeakMap(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch449 switch Float64Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float64Array([index + 1.75]), {
        switch: enabled,
        extra: new WeakMap(),
...
describe('feature flags batch 450 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch450 beacon Uint8Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 1]), {
        beacon: enabled,
        ignored: new Map(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch450 beacon Uint8Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Uint8Array([index + 2]), {
        beacon: enabled,
        extra: new Map(),
...
describe('feature flags batch 451 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch451 signal Int16Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 1]), {
        signal: enabled,
        ignored: new Set(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch451 signal Int16Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Int16Array([index + 2]), {
        signal: enabled,
        extra: new Set(),
...
describe('feature flags batch 452 matrices', () => {
  it.each(Array.from({ length: 80 }, (_, index) => [
    index % 3 === 0,
    index,
  ] as const))(
    'normalizes generated batch452 channel Float32Array own boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 0.5]), {
        channel: enabled,
        ignored: new WeakSet(),
  ...
  it.each(Array.from({ length: 60 }, (_, index) => [
    ...
    'normalizes generated batch452 channel Float32Array alternate boolean property %#',
    (enabled, index) => {
      const source = Object.assign(new Float32Array([index + 1.5]), {
        channel: enabled,
        extra: new WeakSet(),
