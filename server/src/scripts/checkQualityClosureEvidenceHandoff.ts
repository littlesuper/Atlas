import { QualityClosureEvidenceRequirementInput } from '../utils/qualityClosureEvidencePack';
import { buildQualityClosureEvidenceHandoff } from '../utils/qualityClosureEvidenceHandoff';
